...
// TODO: Add isntructions on what parts of these things to change to allow the user to connect to their own network. Move to above in the use definable variables
