...
# Create log file for this session - logs to Julia's Thesis Data/end_effector_logs
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
LOG_DIR = os.path.join(SCRIPT_DIR, '..', "Julia's Thesis Data", 'end_effector_logs')
os.makedirs(LOG_DIR, exist_ok=True)
session_start = datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
LOG_FILE = os.path.join(LOG_DIR, f'end_effector_log_{session_start}.csv')
...
KEY_MAPPINGS = {
    ...
    '2': ('l_elbow_tap', l_elbow_tap),
    '3': ('r_elbow_tap', r_elbow_tap),
    '4': ('l_wrist_tap', l_wrist_tap),
    '5': ('r_wrist_tap', r_wrist_tap),
    '0': ('stop', motors_off),
}
...
print('  2 = Left Elbow Tap')
print('  3 = Right Elbow Tap')
print('  4 = Left Wrist Tap')
print('  5 = Right Wrist Tap')
print('  0 = Stop motors')
print('  q = Quit')
print('----------------------------------\n')
